    ...
    <div className={`${isCollapsed ? 'w-20' : 'w-60 lg:w-72'} bg-gradient-to-b from-[#b8926a] to-[#ede6dd] min-h-screen p-4 ${isCollapsed ? 'flex flex-col items-center' : 'lg:p-6 flex flex-col justify-between'} border-r border-[#dadada] print:hidden text-[#3d2813] transition-all duration-300`}>
      ...
      <div>
        ...
        <nav className="space-y-4">
          <a href="/" className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} text-lg font-normal text-[#3d2813] hover:text-[#5c4028] transition`} title="Patients">
          ...
          <a href="/register" className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} text-lg font-normal text-[#5c4028] hover:text-[#3d2813] transition`} title="New Registration">
          ...
          <a href="https://calendar.google.com" target="_blank" rel="noopener noreferrer" className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} text-lg font-normal text-[#5c4028] hover:text-[#3d2813] transition`} title="Appointments">
      ...
      <div className={`space-y-4 border-t border-[#dadada] pt-6 ${isCollapsed ? 'w-full flex flex-col items-center' : ''}`}>
        <a href="/settings" className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} text-lg font-normal text-[#5c4028] hover:text-[#3d2813] transition`} title="Settings">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="4" y1="21" x2="4" y2="14"></line><line x1="4" y1="10" x2="4" y2="3"></line><line x1="12" y1="21" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="3"></line><line x1="20" y1="21" x2="20" y2="16"></line><line x1="20" y1="12" x2="20" y2="3"></line><line x1="1" y1="14" x2="7" y2="14"></line><line x1="9" y1="8" x2="15" y2="8"></line><line x1="17" y1="16" x2="23" y2="16"></line></svg>
          {!isCollapsed && <span>Settings</span>}
        </a>

        <a href="#" className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} text-lg font-normal text-[#5c4028] hover:text-[#3d2813] transition`} title="Support">
